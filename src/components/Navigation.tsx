  ...
  return <>
      ...
      ease: "easeOut"
        ...
        <div className="container mx-auto px-4 sm:px-6 flex items-center justify-between">
          ...
          }} src="/lovable-uploads/2c0f9ec9-f5de-44cc-9d0e-8eeed5ade603.png" />
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-4">
            <a href="https://www.meetup.com/technexus-community/" target="_blank" rel="noopener noreferrer" className="btn-primary-glow px-6 py-2.5 rounded-full text-sm font-semibold text-primary-foreground">
              Join Community
            </a>
          </div>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && <>
          ...
          opacity: 0
        }} onClick={() => setIsMobileMenuOpen(false)} className="fixed inset-0 bg-foreground/20 backdrop-blur-sm z-40 lg:hidden" />
          ...
          stiffness: 200
              ...
              <div className="flex flex-col h-full p-6">
                ...
                <div className="flex items-center justify-between mb-8">
                  <img src={techNexusLogo} alt="TechNexus Community" className="h-14 w-auto object-contain flex-shrink-0 bg-transparent p-0 shadow-none" style={{
                backgroundColor: 'transparent'
              }} />
                  <button onClick={() => setIsMobileMenuOpen(false)} className="p-2 rounded-lg hover:bg-muted transition-colors" aria-label="Close menu">
                    <X className="w-6 h-6" />
                  </button>
                </div>
                ...
                <div className="mt-auto">
                  <a href="https://www.meetup.com/technexus-community/" target="_blank" rel="noopener noreferrer" className="block w-full btn-primary-glow px-6 py-4 rounded-xl text-center font-semibold text-primary-foreground">
                    Join Community
                  </a>
                </div>
              </div>
