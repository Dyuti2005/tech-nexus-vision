  ...
  return (
    <>
      ...
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 min-h-[96px] ${
          isScrolled ? "glass-card py-3 shadow-lg" : "bg-transparent py-3"
        }`}
      >
        <div className="container mx-auto px-4 sm:px-6 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center flex-shrink-0">
            <img
              ...
              className="h-14 w-auto md:h-24 lg:h-28 object-contain flex-shrink-0 bg-transparent p-0 shadow-none"
              ...
              <div className="flex flex-col h-full p-6">
                ...
                <div className="flex items-center justify-between mb-8">
                  <img
                    src={techNexusLogo}
                    alt="TechNexus Community"
                    className="h-14 w-auto object-contain flex-shrink-0 bg-transparent p-0 shadow-none"
                    style={{ backgroundColor: 'transparent' }}
                  />
                  <button
                    onClick={() => setIsMobileMenuOpen(false)}
