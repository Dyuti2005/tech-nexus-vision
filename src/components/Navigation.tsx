...
const Navigation = () => {
  ...
  return <>
      ...
      duration: 0.6,
      ease: "easeOut"
    }} className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "glass-card py-2 shadow-lg" : "bg-transparent py-4"}`}>
          ...
          stiffness: 200
              ...
              <div className="flex flex-col h-full p-6">
                <div className="flex items-center justify-between mb-8">
                  <img src={techNexusLogo} alt="TechNexus Community" className="h-10 w-auto object-contain" style={{
                background: 'transparent',
                boxShadow: 'none'
              }} />
                  <button onClick={() => setIsMobileMenuOpen(false)} className="p-2 rounded-lg hover:bg-muted transition-colors">
                    <X className="w-6 h-6" />
                  </button>
                </div>
