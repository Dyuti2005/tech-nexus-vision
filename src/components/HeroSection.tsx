        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              >
                {upcomingEvent?.title || "Beyond the Hype: What's Actually Working in AI"}
              </motion.h2>
              ...
              >
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-sm sm:text-base md:text-lg font-medium text-center" style={{ color: 'hsl(220, 20%, 25%)' }}>
                    {upcomingEvent?.date_str || "Saturday, August 22, 2026 · 9:00 AM – 1:30 PM"}
                  </span>
                </div>
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-sm sm:text-base md:text-lg font-medium text-center" style={{ color: 'hsl(220, 20%, 25%)' }}>
                    {upcomingEvent?.venue || upcomingEvent?.location || "Microsoft, Chennai"}
                  </span>
                </div>
              </motion.div>
              ...
              >
                <a
                  href={upcomingEvent?.meetup_link || "https://www.meetup.com/technexus-community/events/315583064/?eventOrigin=group_upcoming_events"}
                  target="_blank"
